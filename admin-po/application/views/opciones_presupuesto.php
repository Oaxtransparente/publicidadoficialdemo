...
<title>Opciones presupuesto</title>
</head>
<body>
...
if($opcion_presupuesto=="ver_presupuesto") { echo 'Presupuesto actual en comunicación social'; }  
if($opcion_presupuesto=="nuevo_presupuesto") { echo 'Ingrese los datos del nuevo presupuesto'; } 
if($opcion_presupuesto=="buscar") { echo 'Resultado de la búsqueda'; }  
if($opcion_presupuesto=="desglose") { echo 'Desglose del presupuesto '; } ?> </h2> </td>
...
<div class="menu2">
<ul>
<li style="width:40%" <?php 
if($opcion_presupuesto=="ver_presupuesto") { echo 'id="primero"'; } ?> >
<a href="<?php echo base_url();?>index.php/presupuesto/principal"> Ver presupuesto </a>
</li>
<li style="width:60%" <?php 
if($opcion_presupuesto=="nuevo_presupuesto") { echo 'id="primero"'; } ?>>
