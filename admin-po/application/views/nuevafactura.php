...
<link href="<?php echo base_url(); ?>calendario-jquery/calendario_dw/calendario_dw-estilos.css" type="text/css">
...
<tr>
<td width="4%">Número de factura: </td>
<td width="30%"><input type="text" name="num_factura" id="num_factura" /> </td>
</tr>
<tr>
<td>Concepto general: </td>
<td><input type="text" name="concepto_general" id="concepto_general"/> </td>
</tr>
<tr>
<td>Monto total: </td>
<td><input type="text" name="monto_total" id="monto_total" onKeyPress="return validar(event)" /> </td>
</tr>
<tr>
<td>Fecha: </td>
<td><input type="text" name="fecha" id="fecha" class="fecha" /> </td>
</tr>
<tr>
<td>Medios: </td>
<td>
...
<table>
<tr>
<td valign="top" width="6%">Imágenes de la factura: </td>
<td width="22%"> 
