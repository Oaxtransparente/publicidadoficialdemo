...
<title>Opciones contratos</title>
</head>
<body>
...
<td align="left">
 <h2> <?php
  if($opcion_contrato=="ver_todo") { echo 'Listado de contratos'; }  
  if($opcion_contrato=="nuevo_contrato") { echo 'Ingrese los datos del nuevo contrato'; } 
  if($opcion_contrato=="buscar") { echo 'Resultado de la búsqueda'; } 
  if($opcion_contrato=="contratos_medio") { echo 'Contratos del medio"'.$medio.'"'; } 
  if($opcion_contrato=="contratos_dependencia") { echo 'Contratos de la dependencia "'.$dependencia.'"'; }?>  </h2> 
</td>
