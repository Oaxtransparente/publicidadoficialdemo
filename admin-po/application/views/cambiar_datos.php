...
<script type="text/javascript">
   ...
   function validar_formulario(){	   	   	  																							   	  												   		   
	   ...
	   document.getElementById('nuevo_password').value!=''&&document.getElementById('repetir_password').value!=''){	
...
<td><input type="text" name="nombre_usuario" id="nombre_usuario" value="<?php echo $nombre_usuario ?>" /></td>
</tr>
<tr>
<td>Password:</td>
<td><input type="password" name="password" id="password" /> 
<?php if (isset($error)) { echo "Error contraseña actual incorrecta";  } ?></td>
</tr>
<tr>
<td>Nuevo password:</td>
<td><input type="password" name="nuevo_password" id="nuevo_password" /></td>
</tr>
<tr>
<td>Repetir nuevo password:</td>
<td><input type="password" name="repetir_password" id="repetir_password" /></td>
</tr>
</table>
