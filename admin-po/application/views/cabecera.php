...
<a <?php if($url_logo_opcional!=""){ 
?> target="_blank" href="<?php echo $url_logo_opcional; ?>" <?php } ?> >
...
<a <?php if($url_logo!=""){ 
?> target="_blank" href="<?php echo $url_logo; ?>" <?php } ?> >
<?php if($logo!="") { 
?>
...
<label style="color:#00B5E2; font-weight:bold;"> <?php echo $nombre_usuario; ?> </label>
<a href="<?php echo base_url(); ?>index.php/usuarios/principal" >
...
<div class="menu" style="margin-top:35px;">
    <ul>    
    <li><a href="<?php echo base_url(); ?>index.php/presupuesto" 
	    <?php if($opcion=="presupuesto") { echo 'id="primero"'; } ?> >Presupuesto</a></li>   
    <li><a href="<?php echo base_url(); ?>index.php/medios" 
	    <?php if($opcion=="medios") { echo 'id="primero"'; } ?> >Medios</a></li>
    <li><a href="<?php echo base_url(); ?>index.php/campa" 
	    <?php if($opcion=="campa") { echo 'id="primero"'; } ?> >Campañas</a></li>
    <li><a href="<?php echo base_url(); ?>index.php/contratos/principal" 
	    <?php if($opcion=="contratos") { echo 'id="primero"'; } ?> >Contratos</a></li>             
    <li><a href="<?php echo base_url(); ?>index.php/facturas/principal" 
	    <?php if($opcion=="facturas") { echo 'id="primero"'; } ?> >Facturas</a></li>
    <li><a href="<?php echo base_url(); ?>index.php/dependencia" 
	    <?php if($opcion=="dependencias") { echo 'id="primero"'; } ?> >Dependencias</a></li>
