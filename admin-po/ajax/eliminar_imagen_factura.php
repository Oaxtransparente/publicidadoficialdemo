<?php 
	...
	mysql_query("delete from tp_imagenes_factura_temp where id_imagen_factura=$id",$db);
									...
									do{
										...
										<td>
										<a style="margin-right:95px;" class="eliminar_imagen_factura" id="eliminar_imagen_factura"
										   href="javascript:void(0);" onclick="eliminar_imagen_factura('.$Reg['id_imagen_factura'].')" 
										   value="'.$Reg['id_imagen_factura'].'" >Borrar</a>
										</td>';                             
