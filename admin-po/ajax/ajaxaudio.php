					...
					if($size<(10024*10024))
						{
							...
							if(copy($tmp, $path.$actual_audio_name))
								{																	
									...
									mysql_query("insert into tp_audios_campa_temp (campa,audio) values (0,'$actual_audio_name')", $db);
									...
									do{																				
											...
											$audios = $audios."
											<tr> 
											<td> <a target='_blank' href='../../jplayer/reproductor.php?audio=".$Reg['audio']."'>"
											.$Reg['audio']."</a></td>";
											
											$audios=$audios.'<td><a style="margin-right:95px;" class="eliminar_audio" 
											href="javascript:void(0);" data-id="'.$Reg['id_audio'].'">Borrar</a></td>
											</tr>';										                             
