<?php 
	...
	mysql_query("delete from tp_audios_campa_temp where id_audio=$id",$db);
									...
									do{
										...
										$audios=$audios.'
										<td>
										<iframe width="120" height="120" src="'.$Reg['audio'].'" frameborder="0" allowfullscreen></iframe> 
										</td>';
										
										if($Reg['audio']!=null)
										$audios_borrar=$audios_borrar.'
										<td>
										<a style="margin-right:95px;" class="eliminar_nuevo_audio" href="javascript:void(0);"
										 onclick="eliminar_nuevo_audio('.$Reg['id_audio'].')" >Borrar</a>
										</td>';	                             
