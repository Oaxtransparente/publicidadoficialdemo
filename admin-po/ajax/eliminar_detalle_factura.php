<?php 
	...
	FROM tp_detalle_factura_temp, tp_dependencia, tp_campa where tp_dependencia.id_dependencia=tp_detalle_factura_temp.dependencia_s and
	...
	while ($fila = mysql_fetch_row($resultado)){ 
       echo '<tr><td>'.$fila[1].'</td>
	             ...
	             <td><a class="eliminar" href="javascript:void(0);" data-id="'.$fila[0].'" 
				     onclick="eliminar_detalle_factura('.$fila[0].')" >Borrar</a></td>
		      </tr>'; 
	}
