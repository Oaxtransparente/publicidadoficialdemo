...
function lista_campas($anio){							
		$query = $this->db->query("select id_campa, nombre, tp_dependencia.dependencia as dependencia_solicitante, 
		anio, descripcion_clasificacion, tp_tipo_campa.tipo as tipo, 
