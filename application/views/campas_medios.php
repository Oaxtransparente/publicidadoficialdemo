...
<td width="8%" align="right" style="border-left:1px solid #7F7F7F;"> 
<label class="letra"> Medio:</label>
</td> 
<td width="15%" align="left"> 
<label class="numero" style="font-size:20px !important"> <?php echo $clasificacion_medio; ?> </label> 
</td>
<td width="10%" align="right" style="border-left:1px solid #7F7F7F;"> 
<label class="letra"> Campañas </label> realizadas: 
</td> 
<td width="10%" align="left"> 
<label class="numero"> <?php echo $num_campas; ?> </label> 
</td>
<td width="10%" align="right" style="border-left:1px solid #7F7F7F;"> 
<label class="letra"> Gastado </label> por medio: 
</td> 
<td width="25%" align="left"> 
<label class="numero"> $<?php echo number_format($costototalmedio); ?> </label> 
</td>
...
?> Última actualización: <?php echo $ultima_actualizacion; 
} ?> </td>
</tr></table>
                ...
                <tfoot>               
                  ...
                  <div style="margin-bottom:0px;" > </div>                                                                                            
                    ...
                    { ?>
                               <tr>
                               <td class="leftb"> 
                               <a href="<?php echo base_url(); ?>index.php/campas/detalle_campa/<?php echo $fila->id_campa ?> ">
							   ...
							   <td class="leftb">
							   <?php echo mb_convert_encoding($fila->clasificacioncampa, "UTF-8") ?></td>
							   
							   <td class="leftb">
							   <?php echo mb_convert_encoding($fila->dependencia_solicitante, "UTF-8") ?></td>						
							   
                               <td class="leftb">
							   <?php echo mb_convert_encoding($fila->cobertura, "UTF-8") ?></td>
                               
                               <td class="leftb">
							   <?php echo mb_convert_encoding($fila->tipomedio, "UTF-8") ?></td>						
