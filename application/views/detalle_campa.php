		...
		$(function() {
			...
			function generateRandomData(node, level) {
				...
				?>	
					...
					label: 'Prensa <br/>$<?php echo number_format($suma_prensa); ?><br/>', 
					amount: <?php echo $suma_prensa; ?>,
					color: '#5C8EA9',																														
					icon: "<?php echo base_url(); ?>imagenes/svg/escrita_icon.svg"																																			
					...
					if($fila->clasificacion==1){ ?>
						...
						var child1 = {
							label: '<?php echo $fila->nombre_comercial; ?> <br/>$<?php echo number_format($fila->monto_medio); ?><br/>%', 
							color: '#5C8EA9',
							amount: <?php echo $fila->monto_medio; ?>																																		
						}
					
						child.children.push(child1);
					<?php } //---end if($fila->clasificacion==1)					
						} //--end foreach($clasificacion_gastos->result() as $fila)				
					} //--end if($num_prensa)
					?>											
					...
					<?php } //--end  if($fila->clasificacion==2)					
					   } //--end foreach
					   ?>
					...
					<?php } //--end if($num_radio==1)
					
					if($num_radio>1){ ?>										
					
					label: 'Radio <br/>$<?php echo number_format($suma_radio); ?><br/>', 
					amount: <?php echo $suma_radio?>,	
					color: '#00B5E2',																													
					icon: "<?php echo base_url(); ?>imagenes/svg/radio_icon.svg"																																			
					...
					if($num_internet>1){ ?>										
					label: 'Internet <br> $<?php echo number_format($suma_internet); ?><br/>', 
					amount: <?php echo $suma_internet; ?>,	
					color: '#35A6B6',																													
					icon: "<?php echo base_url(); ?>imagenes/svg/internet_icon.svg"																																			
					...
					label: 'Tv <br/> $<?php echo number_format($suma_tv); ?><br/>', 
					amount: <?php echo $suma_tv?>,	
					color: '#005862',																														
					icon: "<?php echo base_url(); ?>imagenes/svg/tv_icon.svg"
					};	
					...
					if($num_cine>1){ ?>
					label: 'Cine <br/>$<?php echo number_format($suma_cine); ?><br/>', 
					amount: <?php echo $suma_cine?>,
					color: '#6DA8C6',																														
					icon: "<?php echo base_url(); ?>imagenes/svg/cine_icon.svg"																																			
					...
					label: 'Publicidad exterior <br/>$<?php echo number_format($suma_exterior); ?><br/>', 
					amount: <?php echo $suma_exterior; ?>,	
					color: '#345463',																													
					icon: "<?php echo base_url(); ?>imagenes/svg/exteriores_icon.svg"
					};	
					...
					label: 'Otro <br/>$<?php echo number_format($suma_otro); ?><br/>', 
					amount: <?php echo $suma_otro; ?>,
					color: '#0D95C7',																														
					icon: "<?php echo base_url(); ?>imagenes/svg/otros_icon.svg"
					};	
			...
			var data = generateRandomData({
				label: 'Total gastado:<br/>$<?php echo number_format($total); ?><br/>%<br/>',
...
Nombre de la campaña: <label class="letra"> 
<?php echo $fila->nombre; ?> </label><br/>
Cobertura: <label class="letra"> 
<?php echo $fila->tipo; ?> </label><br/>
Año: <label class="letra"> 
<?php echo $fila->anio; ?> </label><br/>
Dependencia solicitante: <label class="letra"> 
<?php echo $fila->dependencia; ?> </label><br/>
Categoria de la campaña: <label class="letra"> 
<?php echo $fila->descripcion_clasificacion; ?> </label><br/>
...
Inicio 
<label class="letra"> 
<?php echo $fila->periodicidad_inicio;  ?> </label> 
Fin 
<label class="letra"> 
<?php echo $fila->periodicidad_fin; ?> </label>
...
Monto gastado:<br>
<label class="numero_chico"> $
<?php echo number_format($fila->monto_total); ?> </label><br/> </td>

<td width="4%">&nbsp;</td>
<td width="48%" align="left" valign="top"> 
Tema: 
<label class="letra"> 
<?php echo $fila->tema; ?> </label>  <br/>
Objetivo:
<label class="letra"> <?php echo $fila->objetivo; ?></label> <br/>
<?php 
}
?> </td> 
</tr>
...
<div class="raya_completa"> </div><br/>
...
<?php foreach($clasificacion_gastos->result() as $fila) {?>
		...
		if($contador_1==1) {?>
        <tr>
           <td colspan="2" bgcolor="#5C8EA9" style="font-weight:bold; font-size:20px; color:#fff">
           Medios impresos </td>
        </tr>
        <?php } ?>
        <tr>
           <td><?php echo $fila->nombre_comercial; ?></td>
           <td>$<?php echo number_format($fila->monto_medio); ?></td>
        </tr>
        <?php } 
		if($fila->clasificacion==2) { 
		$contador_2++;
		if($contador_2==1) {?>
        <tr>
           <td colspan="2" bgcolor="#00B5E2" style="font-weight:bold; font-size:20px; color:#fff">
           Radio </td>
        </tr>
        <?php } ?>
        <tr>
		...
		if($contador_3==1) {?>
        <tr>
         <td colspan="2" bgcolor="#35A6B6" style="font-weight:bold; font-size:20px; color:#fff">
         Internet </td>
        </tr>
        <?php } ?>
        <tr>
		...
		if($contador_4==1) {?>
        <tr>
          <td colspan="2" bgcolor="#005862" style="font-weight:bold; font-size:20px; color:#fff">
          Televisión </td>
        </tr>
        <?php } ?>
        <tr>
		...
		if($contador_5==1) {?>
        <tr>
          <td colspan="2" bgcolor="#6DA8C6" style="font-weight:bold; font-size:20px; color:#fff">Cine </td>
        </tr>
        <?php } ?>
        <tr>
          <td><?php echo $fila->nombre_comercial; ?></td>
		...
		if($contador_6==1) {?>
        <tr>
          <td colspan="2" bgcolor="#345463" style="font-weight:bold; font-size:20px; color:#fff">Publicidad exterior </td>
        </tr>
        <?php } ?>
        <tr>
          <td><?php echo $fila->nombre_comercial; ?></td>
		...
		if($contador_7==1) {?>
        <tr>
          <td colspan="2" bgcolor="#0D95C7" style="font-weight:bold; font-size:20px; color:#fff">Otro </td>
        </tr>
        <?php } ?>
        <tr>
          <td><?php echo $fila->nombre_comercial; ?></td>
...
<div class="raya_completa" style="margin-top:400px;"> </div>
        ...
        <div id="divCarousel">
			...
			<div id="divCentro">
				<ul>					                    
                    <?php 
					foreach($fotos->result() as $fila) { ?>		                         
                    <li>
     					<a class="fancybox" href="<?php echo base_url(); ?>admin-po/archivos/banners/<?php echo $fila->banner; ?>"
                         data-fancybox-group="gallery" title="">
                         <img width="128" height="128" 
                         src="<?php echo base_url(); ?>admin-po/archivos/banners/<?php echo $fila->banner; ?>">
    					</a>
                    </li>
                    <?php 
					} ?>
				...
				<ul>					                    
                    <?php foreach($videos->result() as $fila) { ?>		                         
                         <li>
                             ...
                             src="<?php echo $fila->video; ?>" allowfullscreen></iframe>
                         </li>
                    <?php } ?>
				</ul>
			</div>
	...
	?>
      ...
      <ol>
         <?php foreach($audios->result() as $fila) { ?>
           <li>
               <a href="#" data-src="<?php echo base_url()?>admin-po/archivos/audios/<?php echo $fila->audio; ?>">
			   <?php echo $fila->audio; ?></a> 
           </li>
         <?php 
		 } ?>
      </ol>
