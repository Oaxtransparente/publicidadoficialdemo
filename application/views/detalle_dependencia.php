...
<head>
	<meta charset="utf-8">
	<title>Detalle dependencia</title>
        ...
        $(document).ready(function(){
           $('#tabla_lista_campas_dependencia').dataTable( { 
...
<br/>
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_campas_dependencia" style="margin-bottom:0px;">
                <thead>                	
                    <tr>
                ...
                <tfoot>               
                  ...
                  <div style="margin-bottom:0px;" > </div>                                                                                            
                   <?php
                   foreach($campas_dependencias_contratantes->result() as $fila)
                   { ?>
                               <tr>
                               <td class="leftb"> 
