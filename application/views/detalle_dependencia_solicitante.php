...
<head>
	<meta charset="utf-8">
	<title>Detalle dependencia solicitante</title>
        ...
        $(document).ready(function(){
           $('#tabla_lista_campas_dependencia_solicitante').dataTable( { 
...
<label class="numero"> <?php echo $numero_campas; ?> </label> </td> 
<td> 
<label class="letra"> Gasto </label> <br/> total <br/>
<label class="numero"> $<?php echo number_format($monto_gastado); ?> </label> </td> 
</tr>
</table>

<br/>

       <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_campas_dependencia_solicitante" 
       style="margin-bottom:0px;">
                ...
                <tfoot>               
                  ...
                  <div style="margin-bottom:0px;" > </div>                                                                                            
                    <?php   
                     foreach($campas_dependencias_solicitantes->result() as $fila)
                     { ?>
                               <tr>
                               <td class="leftb"> 
