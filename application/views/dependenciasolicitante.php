...
<head>
	<meta charset="utf-8">
	<title>Dependencia solicitante</title>
        ...
        $(document).ready(function(){
		   $('#tabla_lista_dependencias_solicitantes').dataTable( { 
...
<form action="<?php echo base_url()?>index.php/dependencias/cargar_solicitante_por_anio/0" method="post">
...
<?php if (isset($ultima_actualizacion)) { ?>Última actualización: 
<?php echo $ultima_actualizacion; } ?> </td>
</tr>
</table>
...
<td width="20%">
<div>
<a href="<?php echo base_url()?>index.php/dependencias/cargar/<?=$anio?>" style="color:#8D8D8D">
Dependencia contratante</a>
</div> </td> 
<td width="20%" class="rellenar_dependencia">
<div>
<a href="<?php echo base_url()?>index.php/dependencias/cargar_solicitantes/<?=$anio?>" style="color:#fff">
...
?>
			...
			<p id="chart">
            <script type="text/javascript" src="<?php echo base_url(); ?>treemap/zoomable_treemap3.js"></script>
            </p>
            
            <br/>

			<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_dependencias_solicitantes" 
                  ...
                  <div style="margin-bottom:0px;" > </div>                                                                                            
                    <?php     
                     ...
                     { ?>
                               <tr>
                               <td class="leftb"> 
                               <a href="../detalle_dependencia_solicitante/<?php echo $fila->id_dependencia ?>/
							   <?php echo $fila->anio?>">
