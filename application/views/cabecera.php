...
<link rel="image_src" href="<?php echo base_url(); ?>/imagenes/logo_PO.png" />

<meta charset="utf-8">
<link rel="stylesheet" media="all" type="text/css" href="<?php echo base_url(); ?>css/estilo.css" />
<title>Transparencia Publicidad Oficial</title>
...
<img src="<?php echo base_url(); ?>imagenes/triangulo_color.png" 
style="float:left; margin-top:-2px; margin-bottom:2px; margin-left:100px;"/>
...
<div class="menu" style="margin-top:35px;">
            <ul>                              	                                                            
             <li>
				 ...
				 <?php if($opcion=="inicio") { echo 'id="primero"'; } ?> >Inicio</a></li>
                              
			 <li>
                 <a href="<?php echo base_url(); ?>index.php/contratosmedios" 
				 <?php if($opcion=="contratosmedios") { echo 'id="primero"'; }  ?> >Medios y contratos</a></li>
                 
             <li><a href="<?php echo base_url(); ?>index.php/campas" 
			 <?php if($opcion=="campas") { echo 'id="primero"'; } ?> >Campañas</a></li>  
                        			
             <li><a href="<?php echo base_url(); ?>index.php/dependencias" 
			 <?php if($opcion=="dependencias") { echo 'id="primero"'; } ?>>Por dependencia</a></li>
             
        	 <li style="float:right; margin-top:-3px; margin-right:15px;">
			 <?=form_open(base_url().'index.php/principal/buscar')?>
			 <input type="text" name="buscar" id="buscar" size="35" value="  Buscar" 
